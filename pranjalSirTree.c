...
void main(){
    int choice, Roko;
    char name1[20];
    struct family data[] = {{150, "DhulChand,       ", 0, 1}, {90, "Ashok,Sharda", 1, 2}, {80, "ChironjiLal,Suman", 1, 3}, {60, "Arvind,prabha", 2, 4}, {58, "Satish,Jainmati", 2, 5}, {48, "Sanjay,Radha", 2, 6}, {58, "jrjadhav,meera", 2, 7}, {55, "Subhash,SonuMani", 2, 8}, {50, "Anil,Pramila", 2, 9}, {41, "Arun,Mamta", 4, 10}, {38, "Ajay,Priyanka", 4, 11}, {37, "Rajni,Sachin", 4, 12}, {29, "Deepika", 5, 13}, {25, "Mayank", 5, 14}, {22, "Abhay", 5, 15}, {21, "Harsh", 6, 16}, {15, "Bhavishya", 6, 17}, {12, "ParthParmar", 10, 18}, {4, "PrayuParmar", 10, 19}, {10, "AdhyanParmar", 11, 20}, {7, "Shanvi", 11, 21}};
    do{
